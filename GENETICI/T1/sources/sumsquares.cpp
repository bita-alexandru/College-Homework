...
void run()
{
    ...
    if(O == 1)
    {
        out.open("axisparallel_NAHC.txt", ios::out | ios::app);
        NAHC();
    ...
    if(O == 2)
    {
        out.open("axisparallel_SAHC.txt", ios::out | ios::app);
        SAHC();
        avg_time = Clock::now() - clk;
        display();
        return;
    ...
    if(O == 3)
    {
        out.open("axisparallel_SA.txt", ios::out | ios::app);
        SA();
        avg_time = Clock::now() - clk;
        display();
        return;
