...
void det(int k = 0)
{
    ...
    {
        x_act[k] = i;
        global_avg_y += ((x_act[k]*x_act[k]) - 10.*cos(2.*PI*x_act[k]));
...
int main()
{
    ...
    case 0:
        {
            out.open("rastrigin_det.txt", ios::out | ios::app);
            auto time_start = Clock::now();
            ...
            global_worst_y = global_avg_y = global_best_y += 10.*N;
            afisare();
            break;
        }
    case 1:
        {
            out.open("rastrigin_nedet.txt", ios::out | ios::app);
            nedet();
            afisare();
            break;
        }
